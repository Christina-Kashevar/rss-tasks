class Calculator {
    ...
    sqrt() {
        if(parseFloat(this.currentOperand) < 0) {
            ...
            let computationSqrt = Math.sqrt(parseFloat(this.currentOperand));
            this.currentOperand = computationSqrt;
...
const exponentButton = document.querySelector('[data-exponentiation]');
